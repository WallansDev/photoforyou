<head>
    <title>PhotoForYou - Timothé VAQUIE</title>
</head>
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="py-5 text-center">
            <img class="d-block mx-auto mb-2" src="./assets/img/logo.png" alt="logo photoforyou" width="170"
                height="115">
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./assets/img//carrousel/carrousel1.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./assets/img//carrousel/carrousel2.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./assets/img//carrousel/carrousel3.png" class="d-block w-100" alt="...">
                </div>
            </div>
        ...
        <div class="jumbotron ">
            ...
            <p class="lead">Découvrez les ./assets/img/ qui vous aideront à vous démarquer.</p>
            ...
            <div class="col mt-4">
                <div class="card-deck" style="color: white;">
                    <div class="card bg-warning border-dark">
                        <img class="card-img-top" src="./assets/img//paysages.jpg" alt="paysages" />
                        <div class="card-img-overlay">
                            <h5 class="card-title">Paysages</h5>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Les paysages</h5>
                            <p class="card-text">Une collection de photos extraordinaires réalisées par des photographes
                                professionnels. Redecouvrez la planète terre ! </p>
                    ...
                    <div class="card bg-success border-dark">
                        <img class="card-img-top" src="./assets/img//portraits.jpg" alt="Elit Amet">
                        <div class="card-img-overlay">
                            <h5 class="card-title">Portraits</h5>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Les portraits</h5>
                            <p class="card-text">Toutes les expressions, tous les visages du sourire aux larmes. Vous
                                trouverez le portrait qu'il vous faut pour vos publications.</p>
                            <a href="#" class="btn btn-primary">Je veux voir...</a>
                        </div>
                        <div class="card-footer">
                    ...
                    <div class="card bg-danger border-dark">
                        <img class="card-img-top" src="./assets/img//evenements.jpg"
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Que ce soit les mariages, férias, soirées DJ. Vous trouverez la photo
                                pour mettre en valeur votre évènement.</p>
